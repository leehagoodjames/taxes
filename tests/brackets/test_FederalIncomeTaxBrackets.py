...
class TestFederalincomeTaxBracket(unittest.TestCase):
    ...
    def test_married_filing_seperately_2022_tax(self):
        self.assertEqual(married_filing_seperately_2022_tax.calculate_taxes(-100), 0)
        self.assertEqual(married_filing_seperately_2022_tax.calculate_taxes(0), 0)
        self.assertEqual(married_filing_seperately_2022_tax.calculate_taxes(100), 10)
        self.assertEqual(married_filing_seperately_2022_tax.calculate_taxes(100 * 1000), 17835.5)
    ...
    def test_married_filing_seperately_2023_tax(self):
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(-100), 0)
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(0), 0)
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(100), 10)
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(100 * 1000), 17400)
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(500 * 1000), 149957)
