...
class TestFederalincomeTaxBracket(unittest.TestCase):
    ...
    def test_married_filing_seperately_2023_tax(self):
        ...
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(100), 0)
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(100 * 1000), 8306.25)
        self.assertEqual(married_filing_seperately_2023_tax.calculate_taxes(1000 * 1000), 179461.25)
    ...
    def test_married_filing_seperately_2022_tax(self):
        ...
        self.assertEqual(married_filing_seperately_2022_tax.calculate_taxes(100), 0)
        self.assertEqual(married_filing_seperately_2022_tax.calculate_taxes(100 * 1000), 8748.75)
        self.assertEqual(married_filing_seperately_2022_tax.calculate_taxes(1000 * 1000), 180818.75)
